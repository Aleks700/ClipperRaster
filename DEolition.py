...
def cutter(wayToTIFSource,maskLayer):


    
# wayToTIFSource = r'W:\share\Alexey\gishagi_kazeosat'
# maskLayer= r'G:\SHAPE_KAZEO_GISHAGY\kazeo_gishagi_23052023.kml'
    ...
    for i in tif:
        ...
        #print(testwayName[-2]+'_'+testwayName[-1])
        # newName = testwayName[-2].split('_')
        newName =  testwayName[-2]+"_"+ testwayName[-1].split('.')[0]
...
cutter(r'W:\share\Alexey\Real_chelyabinsk2023',r'G:\Chelyabinsk\1m.kml')
cutter(r'T:\23\05\08',r'G:\Chelyabinsk\2m.kml')
